...
export const SampleQuizzes = {
    ...
    "SentenceCompletion": {
        ...
        numberOfQuizzes: 15,
        quizzes: [
            new MultipleChoicesQuiz(1, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["すき", "わたし", "はな", "が", "は", "ほ"]), "わたしははながすき", "The correct answer is 「わたしははながすき」(I like flowers)"),
            new MultipleChoicesQuiz(2, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["ねこ", "いぬ", "が", "すき", "は", "です"]), "ねこがすきです", "The correct answer is 「ねこがすきです」(I like cats)"),
            new MultipleChoicesQuiz(3, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["わたし", "は", "がっこう", "に", "いきます", "いえ"]), "わたしはがっこうにいきます", "The correct answer is 「わたしはがっこうにいきます」(I go to school)"),
            new MultipleChoicesQuiz(4, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["ともだち", "と", "あそびます", "は", "が", "で"]), "ともだちとあそびます", "The correct answer is 「ともだちとあそびます」(I play with friends)"),
            new MultipleChoicesQuiz(5, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["わたし", "は", "ほん", "を", "よみます", "が"]), "わたしはほんをよみます", "The correct answer is 「わたしはほんをよみます」(I read a book)"),
            new MultipleChoicesQuiz(6, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["いぬ", "が", "います", "ねこ", "は", "に"]), "いぬがいます", "The correct answer is 「いぬがいます」(There is a dog)"),
            new MultipleChoicesQuiz(7, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["わたし", "は", "おんがく", "を", "ききます", "が"]), "わたしはおんがくをききます", "The correct answer is 「わたしはおんがくをききます」(I listen to music)"),
            new MultipleChoicesQuiz(8, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["わたし", "は", "にほんご", "を", "べんきょうします", "が"]), "わたしはにほんごをべんきょうします", "The correct answer is 「わたしはにほんごをべんきょうします」(I study Japanese)"),
            new MultipleChoicesQuiz(9, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["わたし", "は", "ともだち", "に", "あいます", "が"]), "わたしはともだちにあいます", "The correct answer is 「わたしはともだちにあいます」(I meet my friend)"),
            new MultipleChoicesQuiz(10, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["わたし", "は", "えいが", "を", "みます", "が"]), "わたしはえいがをみます", "The correct answer is 「わたしはえいがをみます」(I watch a movie)"),
            new MultipleChoicesQuiz(11, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["わたし", "は", "りんご", "を", "たべます", "が"]), "わたしはりんごをたべます", "The correct answer is 「わたしはりんごをたべます」(I eat an apple)"),
            new MultipleChoicesQuiz(12, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["わたし", "は", "くるま", "を", "かいます", "が"]), "わたしはくるまをかいます", "The correct answer is 「わたしはくるまをかいます」(I buy a car)"),
            new MultipleChoicesQuiz(13, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["わたし", "は", "うみ", "に", "いきます", "が"]), "わたしはうみにいきます", "The correct answer is 「わたしはうみにいきます」(I go to the sea)"),
            new MultipleChoicesQuiz(14, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["わたし", "は", "やさい", "を", "たべます", "が"]), "わたしはやさいをたべます", "The correct answer is 「わたしはやさいをたべます」(I eat vegetables)"),
            new MultipleChoicesQuiz(15, QuizType.SENTENCES_COMPLETION, "Complete this sentence", shuffleArray(["わたし", "は", "ほん", "を", "かいます", "が"]), "わたしはほんをかいます", "The correct answer is 「わたしはほんをかいます」(I buy a book)")
        ]
    },
}